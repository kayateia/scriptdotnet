//The code in this file is a copy of the file with the same name from Microsoft.Scripting distribution, 
...
namespace Microsoft.Scripting.Math {
  ...
  public class BigInteger : IFormattable, IComparable, IConvertible {
    ...
    public bool TryToFloat64(out double result) {
      try
      {
        result = double.Parse(ToString(10),
...
#else
        throw new ArgumentOutOfRangeException("radix", MathResources.RadixLessThan2);
#endif
      }
      if (radix > 36) {
#if !PocketPC && !SILVERLIGHT
...
#else
        throw new ArgumentOutOfRangeException("radix", MathResources.RadixGreaterThan36);
#endif
